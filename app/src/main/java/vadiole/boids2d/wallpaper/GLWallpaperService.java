...
import vadiole.boids2d.global.extensions.FirebaseExtensionsKt;
import vadiole.boids2d.model.Vector;

import static vadiole.boids2d.wallpaper.BaseConfigChooser.ComponentSizeChooser;
import static vadiole.boids2d.wallpaper.BaseConfigChooser.SimpleEGLConfigChooser;

// Original code provided by Robert Green
// http://www.rbgrn.net/content/354-glsurfaceview-adapted-3d-live-wallpapers
public class GLWallpaperService extends WallpaperService {
    private static final String TAG = "GLWSimpl";
    ...
    public class GLEngine extends Engine {
        ...
        private final SparseArray<Vector> targets;

        public GLEngine() {
            super();
            targets = new SparseArray<>();
        }
            ...
            try {
                ...
                switch (event.getActionMasked()) {
                    ...
                    case MotionEvent.ACTION_POINTER_DOWN: {
                        ...
                        Vector vector = new Vector(event.getX(pointerIndex), event.getY(pointerIndex), 0f);
                    ...
                    case MotionEvent.ACTION_MOVE: {
                        ...
                        int i = 0;
                        while (i < size) {
                            Vector vector = this.targets.get(event.getPointerId(i));
                            if (vector != null) {
                                vector.setX(event.getX(i));
                                vector.setY(event.getY(i));
                            }
                            i++;
                        }
                        break;
                ...
                FirebaseExtensionsKt.log(e, null);
            }

            queueEvent(() -> renderer.onTouch(targets));
        }
